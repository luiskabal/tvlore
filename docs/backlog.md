...
- [x] Submit Android version code `8` to Google Play internal testing with edge-pan back gestures.
...
- [x] Configure Google Play service account JSON in EAS and submit Android version code `3` to internal testing.
...
- [x] Add account-deletion readiness check so Profile can block unavailable destructive actions.
