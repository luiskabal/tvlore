...
| --- | --- | --- |
| Internal testing build | A Play-distributed build that trusted testers can install. | Ready: release `7 (1.0.0)` is active and tester install from Play has been confirmed on device. |
