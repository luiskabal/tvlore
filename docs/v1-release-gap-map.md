...
| --- | --- | --- |
| Internal testing build | A Play-distributed build that trusted testers can install. | In progress: release `2 (1.0.0)` is active, but Play install availability still needs verification on device. |
