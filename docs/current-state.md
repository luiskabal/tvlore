...
| Android release | Internal testing | Google Play app exists, AAB version code 8 is active on the internal testing track, and tester install from Play is confirmed. |
