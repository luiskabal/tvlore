...
- Android package `com.luiskabal.tvlore` has internal testing release `7 (1.0.0)` active in Google Play, and tester install from Play has been confirmed.
...
- Mobile can import a personal Watch Path from a public TMDB Collection URL.
